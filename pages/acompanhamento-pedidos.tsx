...
function Home() {
  ...
  const loadDashboard = useCallback(async (
    ...
    const [dashboardResult, dashboardAlertasResult, resumoHojeResult] = await Promise.allSettled([
  ...
  const indicadoresVisiveis = useMemo(
    () => indicadoresOrdenados.slice(0, 5),
        ...
        <Card className="overflow-hidden border-slate-200 shadow-sm">
          <div className="bg-gradient-to-r from-slate-900 via-primary to-slate-900 px-6 py-6 text-white">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <h1 className="text-2xl font-black tracking-[0.08em] text-white sm:text-3xl">
                ACOMPANHAMENTO DE PEDIDOS
              </h1>

              <div className="hidden grid gap-3 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_auto_auto_auto]">
        ...
        <div>
          <Card className="border-slate-200 shadow-sm" noPadding>
            ...
            <div className="px-3 pt-3 sm:px-4 sm:pt-4">
              <ResumoStatusPedidos itens={resumoStatus} />
            </div>
            <div className="grid gap-3 p-3 sm:p-4 md:grid-cols-2 xl:grid-cols-5">
                  ...
                  {(listaPedidos.titulo === 'ATRASADOS' ? [
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() => void abrirDetalhePedido(pedido)}
                        className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-left shadow-sm transition hover:border-slate-300 hover:bg-slate-50 hover:shadow-md"
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
